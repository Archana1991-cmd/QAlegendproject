...
public class QAlegendUserPage {
	...
	public String insertUserQAlegent(String excelfilepath2, String sheetname) throws IOException {
	...
	public void clickOnSaveButton() {
     ...
     public String enterUsersearch(String searchButton) {
    	WaitUtilities.waitForElementVisibility(SearchButton, 5);
	...
	public String displayedresultBox() {
